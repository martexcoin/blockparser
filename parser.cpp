...
#if defined MARTEXCOIN
    static const size_t gHeaderSize = 80;
    static auto kCoinDirName = ".MartexCoin";
    static const uint32_t gExpectedMagic = 0xf5a23f2d;
#endif
...
static void parseTX(
    ...
    if(!skip) {
        ...
        #if defined(PEERCOIN) || defined(CLAM) || defined(JUMBUCKS) || defined(PAYCON) || defined(MARTEXCOIN)
